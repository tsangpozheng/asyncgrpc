...
class RouteGuideServicer(route_guide_pb2_grpc.RouteGuideServicer):
    ...
    async def GetFeature(self, request):
    ...
    async def ListFeatures(self, request):
    ...
    async def RecordRoute(self, request_iterator):
        point_count = 0
        feature_count = 0
        distance = 0.0
        prev_point = None
    ...
    async def RouteChat(self, request_iterator):
        prev_notes = []
